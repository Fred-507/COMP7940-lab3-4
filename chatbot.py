...
def main():
    ...
    redis1 = redis.Redis(
        ...
        decode_responses=bool(config['REDIS']['DECODE_RESPONSE']),
    ...
    dispatcher.add_handler(CommandHandler("hello", hello))  # Added handler for /hello command
...
def hello(update: Update, context: CallbackContext) -> None:
    ...
    try:
        name = context.args[0]  # /hello <name>
